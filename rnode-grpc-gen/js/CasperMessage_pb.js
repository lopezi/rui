 ...
 * @const
 */
proto.casper.ProcessedSystemDeployProto.repeatedFields_ = [1];
...
/**
 * repeated EventProto deployLog = 1;
 * @return {!Array<!proto.casper.EventProto>}
 */
proto.casper.ProcessedSystemDeployProto.prototype.getDeploylogList = function() {
  return /** @type{!Array<!proto.casper.EventProto>} */ (
    jspb.Message.getRepeatedWrapperField(this, proto.casper.EventProto, 1));
};
...
proto.casper.ProcessedSystemDeployProto.prototype.addDeploylog = function(opt_value, opt_index) {
  return jspb.Message.addToRepeatedWrapperField(this, 1, opt_value, proto.casper.EventProto, opt_index);
};
